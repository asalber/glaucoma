...
En este estudio se pretende definir distintos grupos de gravedad de glaucoma (estadios de desarrollo de la enfermedad) en función del grosor de los anillos neuroretinianos, mediante la técnica de las $k$-medias.

# Estadios

```{r numero-clusters, fig.cap="Reducción de la variabilidad intra-grupos según el número de grupos."}
# Number of clusters
...
## Mapa de los estadios de glaucoma sin incluir ojos sanos

```{r map-clusters-whithout-healthy, fig.cap="Mapa de los estadios de glaucoma sobre los dos primeros componentes principales sin incluir ojos sanos."}
...
## Mapa de estadios de glaucoma incluyendo ojos sanos

```{r map-clusters-whith-healthy, fig.cap="Mapa de los estadios de glaucoma sobre los dos primeros componentes principales incluyendo ojos sanos."}
...
## Distribución del primer componente principal por estadios de glaucoma

```{r clusters-distribution, fig.cap="Distribución del primer componente principal según estadios de glaucoma"}
...
```{r confidence-intervals-means-by-stages, fig.cap="Intervalos de confianza para las medias del grosor los sectores de los distintos anillos según estadios de glaucoma."}
