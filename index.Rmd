...
# Carga de paquetes
.packages <- c("tidyr", "dplyr", "DT", "kableExtra", "psych", "GGally")
...
load("datos/datos-preprocesados.RData")
```
...
Número total de ojos: `r nrow(data)`

Distribución por grupos:

```{r tamaño-muestral}
result <- count(data, Glaucoma)
...
ggpairs(data, mapping=aes(color=Glaucoma, alpha=0.5), columns=c("Sexo", "Edad", "Ojo"))
```
