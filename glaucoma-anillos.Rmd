...
# Carga de paquetes
.packages <- c("tidyverse", "GGally", "gridExtra", "ggpubr", "kableExtra", "psych")
...
```{r histogramas-fobmoangle-displacement-bmoarea, fig.cap="Distribuciones de el ángulo con la fóbea, desplazamiento y área según glaucoma."}
